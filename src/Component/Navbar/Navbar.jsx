...
const Navbar = () => {
  ...
  return (
    ...
    <ul className={` ${menu ? "bg-stone-950  absolute border rounded-md  border-slate-50  text-center top-20 mx-auto left-10 right-10 w-4/5 p-2 transition-all duration-500"  : " absolute top-20 mx-auto left-10 right-10 w-4/5 text-center transition-all duration-500 opacity-0  "}  lg:opacity-100 lg:bg-transparent lg:top-0 lg:mx-0 lg:left-0 lg:right-0 lg:w-full lg:p-0 lg:relative lg:border-none lg:flex font-oswald uppercase gap-5 `}>
