...
const Card = ({ titles, subtitles, images }) => {
  return (
    <div className="flex flex-col w-92 h-80  items-center justify-center border rounded-xl border-orange-50">
      <div className="h-full w-full group relative items-center justify-center overflow-hidden cursor-pointer ">
        ...
        <div className="absolute flex flex-col inset-0 text-orange-50  items-center justify-center gap-3 px-6  translate-y-[100%] group-hover:translate-y-0 transition-all duration-500  ">
